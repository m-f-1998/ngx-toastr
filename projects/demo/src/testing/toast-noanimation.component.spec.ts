...
import { of } from "rxjs"
import { NoAnimationToast, ToastPackage, ToastrService } from "@m-f-1998/ngx-toastr"

describe ( "NoAnimationToast", () => {
  let component: NoAnimationToast
  let fixture: ComponentFixture<NoAnimationToast>
  ...
  beforeEach ( () => {
    ...
    fixture = TestBed.createComponent ( NoAnimationToast )
